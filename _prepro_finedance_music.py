...
parser.add_argument('--input_video_dir', type=str, default='/data/van/Dance/Bailando_new/data/finedance/music_wav')
parser.add_argument('--store_dir', type=str, default='/data/van/Dance/Bailando_new/data/finedance/music_feat_7.5fps')
